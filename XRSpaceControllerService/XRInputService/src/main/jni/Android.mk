...
LOCAL_C_INCLUDES += $(LOCAL_PATH)/controller/SvrControllerUtil/inc/
...
LOCAL_SRC_FILES := ./controller/io_xrspace_controllers_ControllerContext.cpp
LOCAL_SRC_FILES += ./controller/SvrControllerUtil/src/SharedMemory.cpp
...
LOCAL_LDLIBS := -landroid -llog
LOCAL_SRC_FILES := ./controller/io_xrspace_controllers_XRSpaceControllerService.cpp
include $(BUILD_SHARED_LIBRARY)
